...
- **[corrected] Replace the authored replay with persistent inferred state.** The prior
  ...
  density, buoyancy/drag, cohesion, inferred carrier circulation, interfacial velocity coupling,
...
- **[landed] Falsifiable duration and condition controls.** `lava_lamp_inferred_thermofluid`
  guards 21/21 checks. A separate 60 s / 12-tick run has the same bounded internal steps as the
...
- **[landed] Blob-scale circulation and falsifiable merge/split lineage.** The first fused-surface
  ...
  34 changes, surface bodies range from 1 to 8, and 14 coalescences plus 16 fissions occur with
  merged bodies present in 58/101 states. The renderers only reveal this emitted topology.

...
- **[landed] Falsifiable duration and condition controls.** `lava_lamp_inferred_thermofluid`
  guards 22/22 checks. A separate 60 s / 12-tick run has the same bounded internal steps as the
...
- **[landed] Blob-scale circulation and falsifiable merge/split lineage.** The first fused-surface
  ...
  39 changes in the current README run, surface bodies range from 1 to 6, and 19 coalescences plus
...
- **[corrected] Remove the axis-locked convection symmetry.** The first circulation correction
  ...
  19 coalescences and 18 fissions. A dedicated validation flag rejects regression to one-axis

...
- Full slow validation rerun after the CNT curvature step (2026-06-26): `scripts/run_validation_suite.sh` completed with **28 cases, 24 pass / 0 fail-error / 4 info / 0 skip**; glass-of-water validator completed with only last-ULP JSON drift, and optics-surrogate held-out validation remained improved (**extractor MAE 0.1406 → surrogate LOO MAE 0.0839**). No code fixes were needed after the full run.

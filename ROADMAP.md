...
- **[landed] Falsifiable duration and condition controls.** `lava_lamp_inferred_thermofluid`
  guards 19/19 checks. A separate 60 s / 12-tick run has the same bounded internal steps as the

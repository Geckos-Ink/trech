...
- Lava lamp + shared Studio/classic 3D playback (corrected 2026-07-16):
  `lava_lamp_inferred_thermofluid` passes **19/19** checks over a real Geant4 material base,
  ...
  topology, plus fixed-inventory spatial/temporal refinement convergence. The current validation corpus reports **41 cases, 37 pass / 0 fail-error / 0 skip /

...
- Full slow validation suite rerun completed on 2026-06-26 with `scripts/run_validation_suite.sh`: 28 cases, 24 pass / 0 fail-error / 4 info / 0 skip. Glass-of-water validator and optics-surrogate held-out validator also completed (`extractor MAE=0.1406`, surrogate LOO MAE=0.0839, improved=true).
